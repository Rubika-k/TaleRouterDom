         ...
         <div className="steps">
           <div className="row">
             <div className="col-lg-3">
               <div className="item">
                 <img src={Services01} alt="" style={{maxwidth: "66px" ,borderradius: "50%", margin: "0 auto"}}/>
                 <h4>Project Introduction</h4>
               </div>
             </div>
             <div className="col-lg-3">
               <div className="item">
                 <img src={Services02} alt="" style={{maxwidth: "66px" ,borderradius: "50%", margin: "0 auto"}}/>
                 <h4>Work Development</h4>
               </div>
             </div>
             <div className="col-lg-3">
               <div className="item">
                 <img src={Services03} alt="" style={{maxwidth: "66px" ,borderradius: "50%", margin: "0 auto"}}/>
                 <h4>Data Analysis</h4>
               </div>
             </div>
             <div className="col-lg-3">
               <div className="item last-item">
                 <img src={Services04} alt="" style={{maxwidth: "66px" ,borderradius: "50%", margin: "0 auto"}}/>
